...
export const PERSONAL_INFO = {
  ...
  description:
    "Architecte de solutions web avec plus de 4 ans d'expérience dans la conception d'applications métier robustes. Spécialisé en architectures API-first, optimisation de performances et delivery de résultats mesurables.",
...
export const SKILL_CATEGORIES: SkillCategory[] = [
  {
    ...
    label: 'Backend & API',
    skills: [
      { name: 'PHP 8+ / Symfony', level: 95 },
      { name: 'Laravel', level: 88 },
      { name: 'API Platform', level: 90 },
  ...
  },
  {
    ...
    skills: [
      { name: 'Clean Code / SOLID', level: 92 },
      { name: 'DDD / CQRS', level: 75 },
      { name: 'API-First Design', level: 90 },
    ],
  },
  {
    id: 'devops',
